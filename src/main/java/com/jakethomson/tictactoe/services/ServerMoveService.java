...
public class ServerMoveService {
    ...
    public int evaluate(String[] board, String side) {
        ...
        for(int row = 0; row < 3; row++) {
            if(board[row].charAt(0) == board[row].charAt(1) &&
                    ...
                    board[row].charAt(0) != ' ' ) {
                if(board[row].charAt(0) == serverSide) {
                    return +10;
                }
                else {
                    return -10;
        ...
        for(int col = 0; col < 3; col++) {
            if (board[0].charAt(col) == board[1].charAt(col) &&
                    ...
                    board[0].charAt(col) != ' ' ) {
                if (board[0].charAt(col) == serverSide) {
                    return +10;
                } else {
                    return -10;
                }
        ...
        if(board[0].charAt(0) == board[1].charAt(1) &&
                ...
                board[0].charAt(0) != ' ' ) {
            if(board[0].charAt(0) == serverSide) {
                return +10;
            }
            else {
                return -10;
        ...
        if(board[0].charAt(2) == board[1].charAt(1) &&
                ...
                board[2].charAt(0) != ' ' ) {
            if(board[0].charAt(2) == serverSide) {
                return +10;
            }
            else {
                return -10;
